...
const ALL_STRINGS = [
    // Navbar
    'Home', 'Services', 'Projects', 'Portfolio', 'About', 'Pricing', 'Process', 'Reviews', 'Contact', 'Careers',
    ...
    'Reservation Software', 'Custom booking systems for restaurants and hospitality.',
    'We build custom reservation software with your own workflows, guest management, booking limits, and integrations. From small restaurants to high-traffic venues, we can create scalable systems backed by a secure database.',
    'Social Media & Content Creation', 'Grow your audience with consistent content.',
    'We plan and produce social media content tailored to your brand and target audience. From content calendars and post design to campaign direction, we help your business stay active and relevant online.',
    'AI Ads for Any Business', 'AI-powered ad creatives for products and services.',
    'We create AI-powered ad concepts and visual campaigns for any type of product or business. We focus on clear messaging, creative testing, and conversion-ready ad assets for social and search platforms.',
    'Full Stack Software', 'End-to-end systems that manage client bookings and data.',
    'We build and own the full stack — frontend, backend, and database — for custom software that handles client bookings, appointment dates, and secure data storage. From scheduling tools to CRM-style dashboards, you get one team responsible for the entire system, from the interface down to how your data is held.',
    // Portfolio
    'Our Portfolio', "Every website, software platform, and restaurant experience we've crafted — all in one place.",
    'All Work', 'Websites', 'Restaurants', 'Restaurant',
    'Website', 'Software',
    'Visit Website', 'View Project', 'Software Project', 'No projects in this category yet.',
    'View Our Work',
    'Meraki Restaurant', 'La Bella Elena', 'STEKI Foodtruck',
    'Griechisches Restaurant in Bassersdorf with a modern online presence and reservation-ready design.',
    'Restaurant website with elegant branding and a clear, welcoming customer journey.',
    'Greek streetfood foodtruck website with menu, live location finder, and event booking for Wettingen.',
    'Biscottowelt',
    'Greek & Swiss patisserie in Schwerzenbach — handmade cakes, sweets, and custom order flow.',
    'Holiday Base Chania',
    'Beachfront apartment rental site in Stalos, Crete — booking-ready stays steps from the sea.',
    'Mera Cosmetics',
    'Elegant beauty studio website for a Zurich cosmetics and skincare practice, with online appointment booking.',
    'Papageorgiou Fugen', 'Professional business website delivering quality services and solutions.',
    'Portfolio', 'Personal portfolio website showcasing creative work, projects, and professional achievements with modern design.',
    'Inside Observation', 'Professional website dedicated to energy therapies, holistic wellness, and spiritual healing services.',
    'Musician Portfolio', 'Portfolio website for a professional musician — showcasing discography, events, and press kit.',
    'AI Software Platform', 'Advanced AI-powered software solution built with Flowise for intelligent automation and workflows.',
    'Booking & Invitation System', 'Comprehensive software for managing bookings and sending automated invitations to clients.',
    'Professional CRM', 'Custom CRM platform for managing clients, pipelines, and follow-ups in one dashboard.',
    'Retail Sales CRM', 'Custom CRM for a multi-location retail chain, tracking customer profiles, purchase history, and loyalty rewards in one dashboard.',
    'Real Estate CRM', 'Lead and listing management system for a real estate agency, with automated buyer matching and viewing scheduling.',
    'Healthcare Patient CRM', 'Patient relationship platform for a private clinic, handling records, appointment reminders, and automated follow-ups.',
    'Automotive Dealership CRM', 'Inventory-linked CRM for a car dealership, managing test-drive bookings, sales pipelines, and service reminders.',
    'Fitness & Wellness CRM', 'Membership management system for a fitness studio chain, covering class bookings, check-ins, and renewal automation.',
    // Process
    ...
    // Pricing
    'Pricing',
    'Clear packages for websites and advertising — pick what fits, or ask us for a custom mix.',
    'Websites', 'Advertising',
    'Website Package', 'one-time', 'month', 'film',
    'Full business website with clear, transparent pricing',
    ...
    'Product Ads', 'Story Ads', 'Commercial Film', 'MOST POPULAR',
    '12 ads / month', '6 ads / month', '3 ads / month', '1 film / project',
    'Light effort', 'Medium effort', 'High effort',
    'Simple product ads — clean stills and short clips that show what you sell.',
    'Short story-driven ads (about 15–30s) with more concept and editing.',
    'A full cinematic commercial — like a short movie built around your brand.',
    'Up to 12 simple product ads per month',
    ...
    'Packages are based on how many ads you need and how much creative effort each one takes — from simple product shots to full cinematic commercials. Media ad spend is paid to the platforms separately.',
    'The prices shown are our standard package rates. Scope and investment can be adjusted to your needs — feel free to contact us and we’ll prepare a tailored proposal.',
    'All prices exclude VAT.',
    'Contact us about custom pricing',
    // Contact
