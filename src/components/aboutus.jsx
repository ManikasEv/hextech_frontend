                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="bg-secondary rounded-lg shadow-xl overflow-hidden">
                        <div className="p-8">
                            ...
                            <h3 className="text-2xl font-semibold text-white mb-4 text-center"><T>Projects</T></h3>
                            <p className="text-gray-300 text-center">
                                <T>We have successfully delivered over 50 projects across various industries, helping businesses transform their digital presence and achieve their goals.</T>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-secondary rounded-lg shadow-xl overflow-hidden">
                        <div className="p-8">
                            ...
                            <h3 className="text-2xl font-semibold text-white mb-4 text-center"><T>Our Mission</T></h3>
                            <p className="text-gray-300 text-center">
                    ...
                    <div className="bg-secondary rounded-lg shadow-xl overflow-hidden">
                        <div className="p-8">
                            ...
                            <h3 className="text-2xl font-semibold text-white mb-4 text-center"><T>Our Team</T></h3>
                            <p className="text-gray-300 text-center">
