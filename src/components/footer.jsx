                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto items-start">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/hextechit?igsh=dnB2bGFlY3JtdTJ5" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="flex items-start">
                            ...
                            <span>Brüderhofweg 16, 8057 Zürich</span>
                        </p>
                        <p className="flex items-start">
                            <svg className="w-6 h-6 mr-2 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            <span>+41 78 33 17 777</span>
                        </p>
                        <p className="flex items-start">
                            <svg className="w-6 h-6 mr-2 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
